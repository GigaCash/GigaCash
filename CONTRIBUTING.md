Contributing to Gigacash Core
============================

The Gigacash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Gigacash Core project, and is not to be
confused with overall Gigacash Network Protocol consensus changes.

Whether a pull request is merged into Gigacash Core rests with the project merge
...
Patches that change Gigacash consensus rules are considerably more involved than
...
Where a patch set proposes to change the Gigacash consensus, it must have been
...
The project leader is the release manager for each Gigacash Core release.
