...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("GigaCash Core"),
     ...
     * override -datadir in the gigacash.conf file in the default data directory
     * (to be consistent with gigacashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
