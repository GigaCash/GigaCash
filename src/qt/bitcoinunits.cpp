...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(GCASH);
    unitlist.append(mGCASH);
    unitlist.append(uGCASH);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case GCASH:
        return QString("gigacash");
    case mGCASH:
        return QString("mgigacash");
    case uGCASH:
        return QString::fromUtf8("ugigacash");
    default:
        return QString("???");
    }
}
