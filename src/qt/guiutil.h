...
/** Utility functions used by the GigaCash Qt UI.
 */
namespace GUIUtil
{
...
// Render GigaCash addresses in monospace font
...
// Parse "gigacash:" URI into recipient object, return true on successful parsing
