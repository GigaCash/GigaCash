                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GigaCash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GigaCash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gigacash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GigaCash Core"), this);
    aboutAction->setStatusTip(tr("Show information about GigaCash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GigaCash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GigaCash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GigaCash addresses"));
    ...
    openAction->setStatusTip(tr("Open a GigaCash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GigaCash Core help message to get a list with possible GigaCash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GigaCash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GigaCash network", "", count));
}
...
{
    QString strTitle = tr("GigaCash Core"); // default title
