...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Gigacash Core gigacash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gigacash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gigacash transaction") + "\n" +
                               "  gigacash-tx [options] -create [commands]   " + _("Create hex-encoded gigacash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gigacash transaction
