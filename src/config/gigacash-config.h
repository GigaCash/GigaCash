/* src/config/gigacash-config.h.  Generated from gigacash-config.h.in by configure.  */
/* src/config/gigacash-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef GCASH_CONFIG_H

#define GCASH_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.gigacash.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Gigacash Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Gigacash Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "gigacash"
