...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop GigaCash server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "GigaCash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Gigacash features */
        {"gigacash", "masternode", &masternode, true, true, false},
        {"gigacash", "listmasternodes", &listmasternodes, true, true, false},
        {"gigacash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gigacash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gigacash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gigacash", "masternodedebug", &masternodedebug, true, true, false},
        {"gigacash", "startmasternode", &startmasternode, true, true, false},
        {"gigacash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gigacash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gigacash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gigacash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gigacash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gigacash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gigacash", "mnbudget", &mnbudget, true, true, false},
        {"gigacash", "preparebudget", &preparebudget, true, true, false},
        {"gigacash", "submitbudget", &submitbudget, true, true, false},
        {"gigacash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gigacash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gigacash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gigacash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gigacash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gigacash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gigacash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gigacash", "checkbudgets", &checkbudgets, true, true, false},
        {"gigacash", "mnsync", &mnsync, true, true, false},
        {"gigacash", "spork", &spork, true, true, false},
        {"gigacash", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"gigacash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use gigacashd, or the -server option to gigacash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> gigacash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5178/\n";
}
