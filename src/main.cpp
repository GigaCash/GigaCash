...
#if defined(NDEBUG)
#error "GigaCash cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
	...
	else if (nHeight < 40000 && nHeight > 0) {
        nSubsidy = 5 * COIN;
    }
	else if (nHeight <= 80000 && nHeight >= 40001) {
        nSubsidy = 100 * COIN;
    }
	else if (nHeight <= 120000 && nHeight >= 80001) {
        nSubsidy = 80 * COIN;
    }
	else if (nHeight <= 160000 && nHeight >= 120001) {
        nSubsidy = 70 * COIN;
    }
	else if (nHeight <= 200000 && nHeight >= 160001) {
        nSubsidy = 60 * COIN;
    }
	else if (nHeight <= 240000 && nHeight >= 200001) {
        nSubsidy = 50 * COIN;
    }
	else if (nHeight <= 280000 && nHeight >= 240001) {
        nSubsidy = 40 * COIN;
    }
	else if (nHeight <= 330000 && nHeight >= 280001) {
        nSubsidy = 30 * COIN;
    }
	else if (nHeight <= 380000 && nHeight >= 330001) {
        nSubsidy = 25 * COIN;
    }
	else if (nHeight <= 430000 && nHeight >= 380001) {
        nSubsidy = 20 * COIN;
    }
	else if (nHeight <= 480000 && nHeight >= 430001) {
        nSubsidy = 15 * COIN;
    }
	else if (nHeight <= 550000 && nHeight >= 480001) {
        nSubsidy = 10 * COIN;
    }
	else if (nHeight <= 1000000 && nHeight >= 550001) {
        nSubsidy = 8 * COIN;
    }
	else if (nHeight <= 2500000 && nHeight >= 1000001) {
        nSubsidy = 5 * COIN;
    }
	else if (nHeight <= 4000000 && nHeight >= 2500001) {
        nSubsidy = 3 * COIN;
    }	
    else {
        nSubsidy = 1 * COIN;
...
{
    RenameThread("gigacash-scriptch");
