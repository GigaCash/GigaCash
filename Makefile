...
pkgdatadir = $(datadir)/gigacash
pkgincludedir = $(includedir)/gigacash
pkglibdir = $(libdir)/gigacash
pkglibexecdir = $(libexecdir)/gigacash
...
CONFIG_HEADER = $(top_builddir)/src/config/gigacash-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/gigacash-config.h.in \
...
ACLOCAL = ${SHELL} /home/Gigacash/Desktop/LightPayCoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/Gigacash/Desktop/LightPayCoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/Gigacash/Desktop/LightPayCoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/Gigacash/Desktop/LightPayCoin/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/Gigacash/Desktop/LightPayCoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = gigacash
PACKAGE_BUGREPORT = www.gigacash.org
PACKAGE_NAME = Gigacash Core
PACKAGE_STRING = Gigacash Core 1.0.0
PACKAGE_TARNAME = gigacash
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/Gigacash/Desktop/LightPayCoin
abs_srcdir = /home/Gigacash/Desktop/LightPayCoin
abs_top_builddir = /home/Gigacash/Desktop/LightPayCoin
abs_top_srcdir = /home/Gigacash/Desktop/LightPayCoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/Gigacash/Desktop/LightPayCoin/build-aux/install-sh
...
SUBDIRS = src
BITCOIND_BIN = $(top_builddir)/src/gigacashd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/gigacash-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/gigacash-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = GigaCash-Qt.app
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_gigacash_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_gigacash_coverage.info test_gigacash.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/GigaCash-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/gigacash-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/gigacash-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/gigacash-config.h
$(top_srcdir)/src/config/gigacash-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/gigacash-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/GigaCash-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/GigaCash-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/GigaCash-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_gigacash.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_gigacash -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_gigacash_filtered.info: test_gigacash.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_gigacash_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_gigacash_coverage.info: baseline_filtered_combined.info test_gigacash_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_gigacash_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_gigacash_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_gigacash_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_gigacash.coverage/.dirstamp:  test_gigacash_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_gigacash.coverage/.dirstamp total.coverage/.dirstamp

# GigaCash: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_gigacash.coverage/ total.coverage/ $(OSX_APP)
