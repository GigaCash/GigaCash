...
In order to support loading of multiple wallets in gigacash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gigacash.cpp.
...
Changes to gigacash.cpp
----------------------
gigacash.cpp is the entry point into gigacash-qt, and as such, will require some minor modifications to provide hooks for
